...
export default class UpdateAsset extends Component {
  ...
  handleUpdate() {
    ...
    tempAsset.dnaCode = this.refs.dnaCode.value.trim();
    tempAsset.assetCode = this.refs.assetCode.value.trim();
    tempAsset.itemCode = this.refs.itemCode.value.trim();
    tempAsset.description = this.refs.description.value.trim();
    tempAsset.location = this.refs.location.value.trim();
    tempAsset.unitOfMeasure = this.refs.unitOfMeasure.value.trim();
    tempAsset.audited = this.refs.audited.value.trim();
    tempAsset.status = this.refs.status.value.trim();
    tempAsset.capturedOrModifiedBy = this.refs.capturedOrModifiedBy.value.trim();
    tempAsset.dateReported = this.refs.dateReported.value.trim();
    tempAsset.caseNumber = this.refs.caseNumber.value.trim();
    tempAsset.atPoliceStation = this.refs.atPoliceStation.value.trim();
    tempAsset.nextAuditDate = this.refs.nextAuditDate.value.trim();
    tempAsset.appliedBy = this.refs.appliedBy.value.trim();
    tempAsset.checkedBy = this.refs.checkedBy.value.trim();
    this
      .props
      ...
      <div>
        ...
        <form>
          ...
          <div>
            ...
            <div className="inline-div">
              <button type="button" className="asset-submit-button" onClick={this.handleClose}>Close</button>
            </div>
          </div>
        </form>
